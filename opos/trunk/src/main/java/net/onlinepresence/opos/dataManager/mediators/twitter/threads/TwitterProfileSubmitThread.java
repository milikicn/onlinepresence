package net.onlinepresence.opos.dataManager.mediators.twitter.threads;

import twitter4j.Twitter;
import net.onlinepresence.ontmodel.opo.OnlinePresence;
import net.onlinepresence.opos.dataManager.mediators.twitter.service.submitter.TwitterProfileSubmitter;
import net.onlinepresence.opos.dataManager.mediators.twitter.service.submitter.TwitterStatusSubmitter;
import net.onlinepresence.opos.dataManager.mediators.twitter.util.TwitterOnlinePresenceUtil;
